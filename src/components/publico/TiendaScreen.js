    ...
    return (
        <div style={{background: '#fff' , padding: '3% 6vw 3% 6vw'}}>
            ...
            <Row gutter={[16,16]} style={{marginBottom:30,marginTop:25}}>
                <Col xs={24} sm={24} lg={8} style={{borderRight:'1px dashed  #5EC0A7'}}>
                    ...
                    <Button type="primary" size='large' block style={{width:'60%',backgroundColor:'#5EC0A7',border:'1px solid  #5EC0A7',borderRadius:'30px'}} onClick={handleMDF}>
                ...
                <Col xs={24} sm={24} lg={8} style={{borderRight:'1px dashed  #5EC0A7'}}>
                    ...
                    <Button size='large' type="primary" block style={{width:'60%',backgroundColor:'#5EC0A7',border:'1px solid #5EC0A7',borderRadius:'30px'}} onClick={handleVinilo}>
                        <span style={{fontSize:15,fontWeight:'bold'}}>Ver productos</span>
                    </Button>
                    </div>
                </Col>
                ...
                <Col xs={24} sm={24} lg={8}>
                    ...
                    <Button size='large' type="primary" block style={{width:'60%',backgroundColor:'#5EC0A7',border:'1px solid #5EC0A7',borderRadius:'30px'}} onClick={handleCajas}>
                        <span style={{fontSize:15,fontWeight:'bold'}}>Ver productos</span>
                    </Button>
                    </div>
                </Col>

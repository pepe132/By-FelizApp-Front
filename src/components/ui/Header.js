                    ...
                    (navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/webOS/i) || navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/iPod/i) || navigator.userAgent.match(/BlackBerry/i) || navigator.userAgent.match(/Windows Phone/i)) ? (
                        ...
                        >
                            ...
                            <ul style={{width: '100%',display:'list-item',alignItems:'center',justifyContent:'center'}}>
                                ...
                                <li style={{color:'#F58634',fontSize:21,cursor:'pointer', fontWeight:'bold'}}  onClick={(e)=>handleCategoria(e.target.innerText)}>Llaveros</li>
                                <li style={{color:'#F58634',fontSize:21,cursor:'pointer', fontWeight:'bold'}}  onClick={(e)=>handleCategoria(e.target.innerText)}>Libro de firmas</li>
                                <li style={{color:'#F58634',fontSize:21,cursor:'pointer', fontWeight:'bold'}}  onClick={(e)=>handleCategoria(e.target.innerText)}>Portarretratos</li>
                                <li style={{color:'#F58634',fontSize:21,cursor:'pointer', fontWeight:'bold'}}  onClick={(e)=>handleCategoria(e.target.innerText)}>Alcancias</li>
                                <li style={{color:'#F58634',fontSize:21,cursor:'pointer', fontWeight:'bold'}}   onClick={(e)=>handleCategoria(e.target.innerText)}>Termos de acrilico</li>
                                <li style={{color:'#F58634',fontSize:21,cursor:'pointer', fontWeight:'bold'}}   onClick={(e)=>handleCategoria(e.target.innerText)}>Termos de metal</li>
                            ...
                            <img src='https://res.cloudinary.com/dwvfkyc6l/image/upload/v1696345954/logo_halloween_cars3z.jpg' alt='byfeliz' width={170}/>
                                ...
                                <p style={{color:'#F58634'}}><i>&copy; 2024 Copyright : ByFeliz</i> </p>
                            </div>
                        </Drawer>
                        </>
                    ) : (
                ...
                <div>
                    <div>
                        <Row gutter={{xs: 2, sm: 4, md: 8, lg: 16}} style={{padding: '25px'}}>
                            ...
                            <p style={{fontSize:'20px', margin: '3px 0px 0px 0px',textAlign:'center', color:'#F58634', fontStyle:'italic', fontWeight:'bold'}}>Buen dia: {nombre}</p>
                            </Col>
                    ...
                    <div style={{textAlign:'center',marginTop:50}}>
                        <p style={{color:'#F58634', fontWeight:'bold'}}><i>&copy; 2024 Copyright : ByFeliz</i> </p>
                    </div>

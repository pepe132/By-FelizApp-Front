...
export const Header = () => {
  ...
  return (
            ...
            <div style={{width: '100%', textAlign: 'center'}}>
...

                {
                    (navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/webOS/i) || navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/iPod/i) || navigator.userAgent.match(/BlackBerry/i) || navigator.userAgent.match(/Windows Phone/i)) ? (
                        <>
                        <Button type='primary' style={{width:'50%',borderRadius:30,backgroundColor:'white',border:'none',fontFamily:'-moz-initial',marginBottom:'5px'}} onClick={showDrawer} ><span style={{color:'#ECB368'}}>Categorias</span></Button>
                        <Drawer 
                        ...
                        >
                             <Button onClick={onClose}  style={{backgroundColor:'#5EC0A7',border:'none',borderRadius:20,color:'white'}} ><LogoutOutlined />Cerrar panel</Button>
                            <h1 style={{color:'#5EC0A7',fontWeight:'bold'}}><i>Categorias de nuestra tienda</i></h1>
                            <ul style={{width: '100%',display:'list-item',alignItems:'center',justifyContent:'center'}}>

                                <li style={{color:'#5EC0A7',fontSize:21,cursor:'pointer', fontWeight:'bold'}}  onClick={(e)=>handleCategoria(e.target.innerText)}>Llaveros</li>
                                <li style={{color:'#5EC0A7',fontSize:21,cursor:'pointer', fontWeight:'bold'}}  onClick={(e)=>handleCategoria(e.target.innerText)}>Libro de firmas</li>
                                <li style={{color:'#5EC0A7',fontSize:21,cursor:'pointer', fontWeight:'bold'}}  onClick={(e)=>handleCategoria(e.target.innerText)}>Portarretratos</li>
                                <li style={{color:'#5EC0A7',fontSize:21,cursor:'pointer', fontWeight:'bold'}}  onClick={(e)=>handleCategoria(e.target.innerText)}>Alcancias</li>
                                <li style={{color:'#5EC0A7',fontSize:21,cursor:'pointer', fontWeight:'bold'}}   onClick={(e)=>handleCategoria(e.target.innerText)}>Termos de acrilico</li>
                                <li style={{color:'#5EC0A7',fontSize:21,cursor:'pointer', fontWeight:'bold'}}   onClick={(e)=>handleCategoria(e.target.innerText)}>Termos de metal</li>
                            ...
                            <img src='https://res.cloudinary.com/dwvfkyc6l/image/upload/v1678320682/logo_primavera_wltmg5.jpg' alt='byfeliz' width={170}/>
                                ...
                                <p style={{color:'#5EC0A7'}}><i>&copy; 2024 Copyright : ByFeliz</i> </p>
                            </div>
                        </Drawer>
                        </>
                    ) : (
    ...
    <div>
        ...
        <div>
            <div style={{width:'100%'}}>
            <Button type="primary" style={{backgroundColor:'#5EC0A7',border:'none',borderRadius:20}} onClick={closeDrawer}>
                ...
                <div>
                    <div>
                        <Row gutter={{xs: 2, sm: 4, md: 8, lg: 16}} style={{padding: '25px'}}>
                            ...
                            <p style={{fontSize:'20px', margin: '3px 0px 0px 0px',textAlign:'center', color:'#5EC0A7', fontStyle:'italic', fontWeight:'bold'}}>Buen dia: {nombre}</p>
                            </Col>
                            ...
                            (google===false) ? (
                                <Col className='gutter-row' span={24}>
                                    <div style={{display:'flex',alignItems:'center',justifyContent:'center'}}>
                                        <Button style={{borderRadius:30,backgroundColor:'#5EC0A7',border:'none',marginBottom:10,width:'50%'}} block type='primary'  onClick={handleLogout}>
                                            Cerrar sesion
                                        </Button>
                    ...
                    <div style={{textAlign:'center',marginTop:50}}>
                        <p style={{color:'#5EC0A7', fontWeight:'bold'}}><i>&copy; 2024 Copyright : ByFeliz</i> </p>
                    </div>

  ...
  return (
	...
	<footer className='pie-pagina'>
		<div className='grupo-1'>
			<div className='box'>
				<figure>
					...
					<img src='https://res.cloudinary.com/dwvfkyc6l/image/upload/v1696345954/logo_halloween_cars3z.jpg' alt='logo-byfeliz'/>
			...
			<div className='box'>
				...
				<p><PhoneFilled /> (+52) 449 257 09 76</p>
		...
		<div className='grupo-2'>
			<small>&copy; 2024 <b>ByFeliz</b> - Todos los derechos reservados</small>
